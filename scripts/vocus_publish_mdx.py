...
TAGS = {
    ...
    'fear-of-blowing-up-2026-09': ['內心的恐懼', '恐懼', '交易', '停損'],
...
COVERS = {
    ...
    'xiaotian-2026-04-25-qwen-27b-20-to-184-tokens': 'xiaotian-2026-04-25-qwen-27b-20-to-184-tokens.png',
...
# 簽名檔（2026-09-10 Charles 兩次拍板：加佳句與行事曆→佳句改用大師名言「上網找比自己創好」）
# 名言皆為公認出處、附原作者；按 slug 固定輪替，同一篇永遠同一句。
SIGN_QUOTES = [
    '別人貪婪時恐懼，別人恐懼時貪婪。── 華倫・巴菲特',
    '潮水退了，才知道誰在裸泳。── 華倫・巴菲特',
    '市場短期是投票機，長期是體重計。── 班傑明・葛拉漢',
    '第一條規則：不要賠錢。第二條規則：別忘記第一條。── 華倫・巴菲特',
    '反過來想，永遠要反過來想。── 查理・蒙格',
    '投資人為了防備回檔而賠掉的錢，遠比回檔本身賠掉的多。── 彼得・林區',
    '成功的投資不是買到好東西，而是把東西買得好。── 霍華・馬克斯',
    '市場保持非理性的時間，可以比你保持不破產的時間更久。── 凱因斯',
]
...
def signature_blocks(slug):
    ...
    return [('p_italic', q), ('p', SIGN_SCHEDULE)]
