...
cover: "/covers/when-exit-codes-lie.png"
ogImage: "/covers/when-exit-codes-lie.png"
---

![A figure bent under a lamp studying a single feather, while an enormous cart of firewood looms unnoticed in the shadow just behind their back](/covers/when-exit-codes-lie.png)
...
That empty bracket is what made me stop trusting green lights. The light was really on; it's just that what it measured had come unhooked from what I cared about. Since writing this, every check that has never gone red gets the same first thought from me: could this one be incapable of going red?

Here's a small thing I tried, if you want to try it: today, pick the check you're most relaxed about — the one that has never once complained: the monthly reconciliation, the weekly report, some health check's tick mark. Go back to the last day it showed green and find the exact number or file it actually looked at. Write that thing on a piece of paper, and next to it write what you really wanted to know. Line the two up. If they aren't the same thing, that green light has never once been watching the door for you. My first time, the pair was "output larger than one byte" and "did the task finish" — a long way apart, and that light had been green for two years.
