---
title: "Who's Really Behind the 'Steady Index, Bleeding Stocks' Market? Notes on Gooaye EP680 — A 15% Drawdown Playbook, TSMC Mispriced, and a Misread AI 'Threat'"
...
![An equity curve slides from its peak, and once it touches the dashed line at minus fifteen percent the swings visibly shrink and the line turns grey; left of that point is marked attack with single stocks and high beta, right of it defence with index futures and a broad ETF.](/figures/drawdown-15-switch-to-defense-en.svg)
...
![Two lines leave the same point heading right: the index above stays almost flat while single stocks below fall steeply, opening a large gap at the right marked multiple compression.](/figures/index-steady-stocks-bleeding-en.svg)
...
![Two rectangles side by side: the left is tall and narrow for high unit cost and small volume, the right is short and wide for low unit cost and large volume, and the right area is clearly bigger, with area standing for total consumption.](/figures/jevons-paradox-area-en.svg)
...
![Two rows each hold a tall and a short bar, and the short bars are exactly the same height in both rows; in the top row the upper multiple section is cut away, in the bottom row the lower earnings section is, marked opportunity and trap respectively.](/figures/multiple-compression-vs-earnings-cut-en.svg)
