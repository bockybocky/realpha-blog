...
![A three-layer funnel narrowing downward: the widest top layer is free content with a hundred viewers, the middle layer narrows to trust with twenty staying, and the narrowest filled layer is the paid course with three buyers, showing the free layer exists to funnel people down.](/figures/content-funnel-three-layers-en.svg)
...
![Two panels of bars: on the left only three winning trades adding to plus ten; on the right all ten trades over the same period, up and down, and after subtracting a cost bar the total becomes minus one.](/figures/cherry-picked-vs-all-trades-en.svg)
