...
![On the left a round wafer cut by a square grid yields only nine whole squares with broken fragments all around the rim; on the right a square panel of the same size is fully packed with sixteen whole squares and no broken corners.](/figures/round-wafer-square-die-waste-en.svg)
...
![Three bars of different length on a timeline from 2026 to 2029: the low and mid end runs solid the whole way from today, while high end and glass are short dashed bars on the right, and the long empty space on the left is what investors are buying now.](/figures/plp-three-stages-timeline-en.svg)
