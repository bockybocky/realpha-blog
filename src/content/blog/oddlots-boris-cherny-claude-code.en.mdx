...
![A stepped line: three slow steps on the left, then a very long flat stretch, then two steps in quick succession on the right, with the right-hand rise clearly larger than the left.](/figures/fifty-years-two-steps-en.svg)
...
![Two panels compared: on the left three filing cabinets sit in the middle and the computer is squeezed into the bottom-right corner; on the right the computer is in the centre with lines radiating out, and the filing cabinets are crossed out and pushed to the edge.](/figures/computer-corner-vs-center-en.svg)
...
![Seven bars of equal height stand side by side, and only the middle one marked switching costs has been cut down sharply, with a dashed line showing its old height while the other six stay put.](/figures/moat-only-one-erodes-en.svg)
