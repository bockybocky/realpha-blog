...
![Ten bars rising fast from almost nothing, the second-to-last only half the height of the last, and the first eight barely off the ground](/figures/exponential-last-day-en.svg)
...
![Two funnels facing opposite ways; the left widens from narrow to broad, the right narrows from broad to thin](/figures/expand-vs-compress-en.svg)
...
![Two bars of equal length; the upper one is a single color throughout, the lower one has more than half switched to another color](/figures/funding-flip-cashflow-to-debt-en.svg)
...
![A line of sight from an eye on the left passes through a dashed box in the middle and lands on three solid blocks on the right](/figures/lender-looks-past-the-datacenter-en.svg)
...
![Two short bars starting from the same point inside a long frame that stands for the whole market, the upper bar slightly longer than the lower](/figures/ig-credit-share-en.svg)
...
![A tall narrow block beside a short wide block, the two of equal area](/figures/deflation-treadmill-area-en.svg)
...
![Five dots spread at different heights on the left, five lines carrying them to the right, where the five dots sit almost on one horizontal line](/figures/variance-collapse-en.svg)

![Twenty cells on the left with only seven lit, and a stack of boxes with an upward arrow on the right](/figures/idle-fleet-and-hoarding-en.svg)
...
![A tall bar on the left sends out twenty thin lines that fan out and all point to the same box on the right](/figures/many-small-paths-en.svg)
...
![Two blocks of equal width, the left tall and the right short, their bases exactly the same width](/figures/multiple-explains-the-drop-en.svg)
...
![A timeline with the listing date marked at the right end, while the curve for today's winners starts bending down well before it](/figures/pressure-arrives-before-the-flood-en.svg)
...
![Five lines bend down together inside the left box, while in the right box four lines run flat and only one falls](/figures/forced-selling-falsifiable-check-en.svg)
