...
![A brain block sits above two production lines side by side; an arrow down the left marked spec and an arrow up the right marked output, which passes through a review block on the way, forming a clockwise loop.](/figures/judgment-up-typing-down-en.svg)
...
![Three report blocks along the top face three reality blocks along the bottom, and each of the three connecting lines carries a cross in the middle, meaning every report failed to match what was actually there.](/figures/report-versus-reality-en.svg)
...
![Four jobs running at once are drawn as blocks on the left, and four curves converge rightward into a single review node, with one of them marked as reassigned midway.](/figures/parallel-night-converge-en.svg)
