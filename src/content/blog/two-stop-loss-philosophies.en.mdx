...
ogImage: "/covers/two-stop-loss-philosophies-cover.png"
cover: "/covers/two-stop-loss-philosophies-cover.png"
---

![Oil-painting magical-realism cover: a traveler at a fork decisively turns away from a dark stormy road, back toward a warm distant home and light across the fields](/covers/two-stop-loss-philosophies-cover.png)

> *I see the past can't be argued back —*<br/>
> *but the road ahead is still mine to pursue.*<br/>
...
![Two panels show two ways of cutting the same position: on the left an upright block is sliced by a horizontal line a third of the way down with the part below greyed out, a stop cutting at a price; on the right a large frame holds only one narrow column, a cap cutting at size.](/figures/two-cuts-price-vs-size-en.svg)
...
![A curve that is gentle on the left and turns up sharply at the right, with loss along the horizontal axis and the gain needed to break even up the vertical: at a fifty percent loss the curve is still low, at eighty percent it shoots to the top.](/figures/drawdown-recovery-curve-en.svg)
