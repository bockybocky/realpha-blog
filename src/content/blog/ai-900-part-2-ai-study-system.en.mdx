...
![On the left, a scatter of small blocks with a few marked in warning colour; on the right, those same misses stacked into five columns of different heights, with the tallest one obvious at a glance.](/figures/wrong-log-stacks-into-weak-branch-en.svg)
...
![A tree growing upward: one trunk sentence at the bottom, five branches above it, each carrying a single leaf, with a note on the right that leaves are forgotten while a trunk lets you reason.](/figures/concept-tree-trunk-before-leaves-en.svg)
...
![A timeline drawn to scale: the two preparation segments in the hour before the exam are together longer than the forty-five minutes of answering on the right.](/figures/exam-day-timeline-prep-longer-than-test-en.svg)
