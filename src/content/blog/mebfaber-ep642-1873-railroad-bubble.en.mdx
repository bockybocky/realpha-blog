...
![On the left a pit marked equities stands for the bear market from 1845 to 1850; an arrow carries the money to the right, where a tall column is stacked from British gilts, French bonds and railways and ports, with a crack marked 1873 on its right edge.](/figures/bond-boom-escaping-the-last-crash-en.svg)
...
![A bar at the top stands for the German economy with a fifth of it filled at the left end, marking the billion-dollar indemnity injected in two years; three equal blocks below run left to right as the same money turns from bonds into cash into shares.](/figures/reparations-money-changes-hands-en.svg)
...
![A line falling left to right in three stages: Vienna halves in May, then a warning-coloured horizontal plateau where nothing happened, then New York drops steeply in September, and finally a gentle slide to Egypt and Turkey.](/figures/three-stage-crash-false-calm-en.svg)
...
![On the left three equal blocks stand for silver, gold and mixed standards each covering a third of the world; on the right the silver block is crossed out and greyed, and all three arrows press onto the remaining gold block.](/figures/safe-asset-denominator-shrinks-en.svg)
...
![A horizontal line stands for debt unchanged over twenty years while another line falls from the same point as prices drop thirty percent, and the widening gap between them is filled in and marked as a heavier and heavier millstone.](/figures/deflation-debt-millstone-en.svg)
