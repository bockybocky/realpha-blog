...
![Two bars: a script-driven agent fills 80 percent of a video edit; the remaining 20 percent, the part that decides quality, is only reachable by driving the editor directly](/figures/eighty-twenty-editing-en.svg)
