...
![A long gray bar standing for every company she has invested in, with only the leftmost tenth marked in blue for the share that could not have raised without her round; below, two boxes contrast what she can really swing — the next block of compute — against whether the money gets raised at all](/figures/vc-marginal-value-sliver-en.svg)
...
![Two panels compared: on the left a large circle standing for one person in a 200-person lab, on the right the same person shrunk to a dot scattered in a dense grid, standing for individual weight diluted by scale](/figures/agency-shrinks-with-scale-en.svg)
...
![A box on each side, one for what the models are good at and one for where customers hurt, with two arrows pointing inward and meeting in a middle box labeled law](/figures/two-directions-meet-in-middle-en.svg)
...
![A four-quadrant chart with whether the thing will happen on the horizontal axis and how much the price already assumes on the vertical: bottom right is the opportunity, top right is right but unpaid, top left is the costliest mistake, bottom left is harmless](/figures/trend-vs-price-quadrant-en.svg)
...
![Three center-aligned bars narrowing from wide to narrow, stacked top to bottom into a funnel: find the truth, find it wrongly priced, hold it; beside the narrowest is the note that most people drop out here](/figures/three-gates-narrowing-en.svg)
...
![Above, a falling stock price line; below, two rows of reasons compared before and after the fall: he is excellent still holds afterward and so tells you nothing, while margin holds above a level is disproved and so tells you what to do next](/figures/reason-survives-the-drawdown-en.svg)
...
![Five bars shortening from top to bottom for the layers of the supply chain: data centers at the top are the widest and easiest to buy, each layer upstream narrows, and skilled labor and tacit knowledge at the bottom are shortest](/figures/supply-chain-thin-sieve-en.svg)
