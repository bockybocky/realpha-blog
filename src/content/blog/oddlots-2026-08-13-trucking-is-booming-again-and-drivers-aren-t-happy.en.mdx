...
![Two supply-and-demand panels: on the left the demand line shifts right and both price and quantity rise, while on the right the supply line shifts left and price rises as quantity falls. Price rises in both, but volume moves the opposite way.](/figures/freight-rate-two-causes-en.svg)
...
![On the left three large blocks and a field of small ones face a wall with an opening only at the top; the large blocks pass through to the shipper on the right while all the small ones are held outside.](/figures/capacity-behind-the-gate-en.svg)
...
![Two bars made of cells: the upper one has all fourteen filled, meaning the clock keeps running, while the lower one has only the first eleven filled and the last three are empty dashed frames marked hunting for parking.](/figures/clock-runs-wheels-dont-en.svg)
...
![Two stacked bars: the left has three layers, from the bottom the lifestyle sacrifice, the pay and the freedom; the right has only two, with the top layer turned into an empty dashed frame.](/figures/the-job-equation-lost-a-block-en.svg)
...
![A block marked rates rising branches to the right: one thick line runs up to those who benefit and five thin lines fan down to those who lose, with far more lines going down.](/figures/same-headline-two-directions-en.svg)
