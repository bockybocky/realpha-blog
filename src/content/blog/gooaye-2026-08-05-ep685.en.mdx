...
![A price line drops sharply to a trough and recovers quickly, with only a very narrow band at the trough marked as the actual window; below it a much wider grey bar is marked as the range people imagine.](/figures/cheap-is-a-window-en.svg)
...
![Two rows share the same narrow window band: the upper row crams research, emotion and decision into the band and overflows it, while the lower row lays list, price and reason out before the window, leaving only a small execution block inside it.](/figures/research-before-cheap-en.svg)
...
![One piece of bad news splits into two paths: along the top the calendar marker slides one slot to the right and the reason-to-hold block stays intact; along the bottom the calendar does not move but the reason-to-hold block is struck through.](/figures/timeline-or-demand-en.svg)
...
![Three downward bars stand for the drawdown you can survive: the unleveraged bar just reaches the line marked down forty percent, while the two-times and four-times bars stop at half and a quarter of it, hanging well above the line.](/figures/leverage-decides-depth-en.svg)
