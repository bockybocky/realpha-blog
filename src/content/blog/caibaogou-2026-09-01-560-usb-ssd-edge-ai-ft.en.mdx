...
![On the left a thick heavy laptop with two large gray blocks inside taking up half the body; on the right just one slim USB stick, a stark difference in size](/figures/usb-before-after-en.svg)
...
![On the left supply is a single short bar; on the right demand is three small blocks multiplied together into a bar far taller](/figures/supply-add-demand-multiply-en.svg)
...
![Three horizontal bars from short to long, stacking from one unit of material to ten at the maker to sixty at the end user](/figures/cost-stacking-to-end-user-en.svg)
...
![Three bar groups: the amount rises, the unit price rises further, and the third group for actual capacity shrinks instead](/figures/inventory-amount-up-volume-down-en.svg)

![On the left a straight-line process that breaks off halfway; on the right a closed loop that keeps circling back to the start](/figures/read-first-vs-play-first-en.svg)
...
![Two columns side by side; the left holds accomplished facts you can go and verify, the right holds bets that have not happened yet](/figures/two-piles-checkable-vs-bet-en.svg)
...
![A merged question crossed out at the top, splitting below into two separately trackable tracks](/figures/shortage-and-price-two-tracks-en.svg)
...
![Two timelines of very different length; the lower one is cut short at a dip partway along](/figures/timeline-mismatch-en.svg)
...
![On the left an arrow held out without having taken it breaks off partway; on the right three rings spread outward from his own circle](/figures/take-the-pill-first-en.svg)
