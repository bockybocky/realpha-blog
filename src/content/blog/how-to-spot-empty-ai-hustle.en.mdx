...
![Two panels compared. Before, both judgment and loss sit inside the box marked you; after an arrow marked outsource, judgment has moved into the box marked AI while loss stays in your box at exactly the same height.](/figures/outsource-judgment-keep-loss-en.svg)
...
![A three-layer funnel narrowing downward from free content to a mailing list to a paid course, with an arrow down the left marking falling headcount and an arrow up the right marking rising price, and the narrowest layer framed in an accent colour.](/figures/free-content-funnel-layers-en.svg)
...
![A block marked the same AI on the left splits into two curves running in opposite directions: the upper one, marked can tell the difference, leads to leverage; the lower one, marked cannot, leads to an amplifier, with the two end boxes in different colours.](/figures/same-tool-two-directions-en.svg)
