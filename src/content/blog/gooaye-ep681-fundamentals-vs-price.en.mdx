...
![Three groups of blocks: the top row keeps eight GPUs throughout while the bottom row goes from one CPU to four and then eight, moving the ratio from one to eight toward one to one.](/figures/cpu-gpu-ratio-shift-en.svg)

![Two downward bars compare the size of the fall, with the high-multiple one much longer, and a curved arrow runs from the left to the right to show money moving across.](/figures/expensive-gets-killed-cheap-defends-en.svg)
...
![A price line runs sideways for a long time just above a floor and only lifts in the right-hand section; the floor is held by fundamentals and the area above is marked as timing you cannot pin down.](/figures/floor-versus-timing-en.svg)
