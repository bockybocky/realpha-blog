...
![Money from four short bars flows along arrows into one very tall bar at the centre, and that tallest bar is split across its middle by a horizontal crack marked as the breach.](/figures/crowded-fortress-cracks-en.svg)
...
![Two panels: on the left six position blocks move as a group from one column to another and still total six; on the right the same six are reduced to two solid ones with the rest turned into empty dashed frames.](/figures/move-position-vs-cut-exposure-en.svg)
