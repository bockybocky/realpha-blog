...
![On the left a clockwise loop whose four nodes grow larger around the ring; on the right a line climbing slowly and then falling straight down from the top](/figures/credit-cycle-spiral-and-cliff-en.svg)
...
![Two panels, each with a line from the same starting point: on the left it falls to the lower right, on the right it climbs, the two slopes opposite](/figures/same-move-opposite-verdict-en.svg)
...
![Two value curves from the same starting point: one falls gently and stretches far, the other drops steeply to the floor](/figures/collateral-decay-slope-en.svg)
...
![On the left a cloud with blurry edges; on the right four short items in a row, each with a checkbox](/figures/blob-versus-four-checkable-points-en.svg)
...
![Along a timeline, four small upward ticks come first and only at the end does a large downward break appear](/figures/expectation-moves-before-price-en.svg)
...
![A fan opening to the right from a point on the left, with one region marked inside it and, outside and below the fan, another point set off by a dashed line](/figures/analysis-has-a-range-en.svg)
