...
![Six nutrient bars of different heights side by side; the shortest draws a dashed line across the whole figure, and no matter how tall the other five grow the line does not move](/figures/liebig-minimum-nutrient-en.svg)
...
![A five-box supply chain from upstream to end device; a brace above the two middle boxes marks where attention used to sit, and an arrow below the most upstream box points out the new bottleneck](/figures/bottleneck-moved-upstream-en.svg)
...
![Five bars of different lengths on a timeline from 2026 to 2030, their starts stepped back one after another and their right ends all aligned at 2030](/figures/capacity-locked-to-2030-en.svg)
...
![Two lines running opposite ways cross in the middle; the horizontal axis is how long the shortage lasts, with the signers winning left of the crossing and the refusers winning right of it](/figures/long-contract-symmetric-bet-en.svg)
...
![Three independent two-point lines side by side, all three sloping from lower left to upper right, pointing the same way](/figures/three-independent-upward-revisions-en.svg)
...
![A bar cut across by a horizontal line: below the line the solid part is what can be delivered, above it a dashed box is what cannot, and a lower dashed line marks the original market consensus](/figures/demand-capped-by-capacity-en.svg)
...
![Two grids of fields of the same size; the left is mostly light squares, the right is filled with dark squares except three still highlighted in the lower right corner](/figures/carrot-field-squeezed-out-en.svg)
...
![A three-step staircase descending from upper left to lower right, each step topped with blocks standing for demand, two arrows pushing blocks down a step, and the lowest step piled highest](/figures/shortage-cascades-down-spec-ladder-en.svg)
...
![One long bar cut into six segments of very different widths, with the narrow segment at the far right called out separately by a leader line](/figures/price-move-decomposition-en.svg)
...
![A timeline cut into three stretches; a bar above marking the language in transcripts covers only the first two, a bar below marking news coverage covers only the last, and the price line turns up only in the final stretch](/figures/bottleneck-three-stages-en.svg)
...
![A four-quadrant chart with degree of shortage on the horizontal axis and gross margin on the vertical; a marked point sits in the upper right and another in the lower right, equally short but with margins moving opposite ways](/figures/shortage-versus-pricing-power-en.svg)
...
If one line survives from these forty-odd posts, for me it's this: watch who is turning orders away. "We had to decline customers" proves three things in one breath — demand has overflowed, capacity can't keep up, and the gap isn't a one-quarter thing. And it sits right there in public information.

The line works outside investing too, and here's a small thing I tried. Think back to the last time you were turned away: the restaurant booked out until next month, the plumber who couldn't fit you in, the doctor with a three-month wait. Today, write that business's name and the wait it quoted you in your phone's notes, with the date. Three months on, look back once and see whether it has raised prices or become even harder to book. My first entry was a car repair shop; three months later its labour rate was up twenty percent, and I realised I had seen the signal early and filed it under "inconvenient."

If you want to go one step further: next time you're choosing between options, ask "when's the soonest you can do it" before you ask "how much."