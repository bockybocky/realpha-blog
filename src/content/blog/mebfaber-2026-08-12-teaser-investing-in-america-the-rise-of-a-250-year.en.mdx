...
![Twelve bars stand for twelve colonial bets, almost all short and flat with only one in the middle reaching the top, the shape of a power law rather than an average.](/figures/colony-portfolio-power-law-en.svg)
...
![Two panels compared: on the left there is no bridge between the two platforms and the dots standing for capital all pile up on the near bank; on the right a bridge marked property rights, contracts and governance is in place and the dots queue across to the far side.](/figures/institutions-are-the-bridge-for-capital-en.svg)
...
![Three blocks of different height on a 227-year timeline stand for annualised returns of 6.8%, 11.3% and 7.3%, with a dashed line at the 8.8% average and the twenty-billion result in the upper right.](/figures/two-hundred-years-annualized-en.svg)
...
![Four household ownership bars run from high to low: sixty percent in the United States, a third in the UK, and low teens in Japan and the Netherlands, each topped by a crown, but the last three crowns belong to the past.](/figures/crown-changed-three-times-en.svg)
...
![A bar standing for two thirds of global market cap is cut into two parts: the left, the share of earnings actually made, points to a plus for future returns, and the right, the multiple the market grants, points to a minus.](/figures/two-thirds-strength-versus-price-en.svg)
