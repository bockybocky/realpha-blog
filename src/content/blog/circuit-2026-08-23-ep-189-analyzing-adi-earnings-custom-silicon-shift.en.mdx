...
![On the left a very tall bar stands for the $100 billion of a 1 GW data center, with only a hairline blue sliver at its base for the $1 to $1.5 billion of analog; a dashed line carries that sliver to the right, where on ADI's own revenue ruler it becomes a block taking up most of the height](/figures/analog-content-two-rulers-en.svg)
...
![In the top row the chipmaker's arrow goes straight to the customer and the bar on the right is tall, marked 74%; in the bottom row it passes through distribution first, marked with price competition, and the bar on the right is clearly shorter](/figures/two-channels-two-margins-en.svg)
...
![A large frame is the whole market, holding a small blue block for the part I can actually sell into; only the small block has a solid arrow down to next quarter's revenue reconciliation, while the rest of the frame has a dashed arrow to nothing checkable](/figures/tam-sam-what-gets-checked-en.svg)
...
![A growth-rate curve surges, sags in the middle and rises again by 2028; the first stretch is shaded as eating design-ins and the later stretch as eating volume shipments, with the sag marked in a warm color as the gap](/figures/growth-gap-between-two-demands-en.svg)
...
![On the left a solid frame is the company's financial statements with a few neat rows inside; an arrow moves a block labeled a real obligation out into a dashed SPV bubble beyond the frame, with notes beside it that the funders expect a return and that this route costs more](/figures/spv-moved-off-the-frame-en.svg)
...
The line that stayed with me is Jay's: debt puts you on a timetable. Chip companies stayed out of debt for fifty years not because they were old-fashioned but because they knew the repayment date wouldn't wait for the next product generation. I went and looked at my own calendar after this and found that half the dates in it weren't set by me.

A small thing you might try: next time you open your calendar, pick out everything in the next three months that has to be delivered on a fixed day no matter what, and count two numbers — how many there are, and how many of those dates were set by someone else in exchange for something you wanted (money, an opportunity, a promise). Write it on paper as a fraction, like 4/7.

The numerator is your real risk exposure — not because those things are dangerous, but because in those boxes "let's wait and see" is no longer on the menu. My first count was 5/6, uglier than I expected. Look again in three months and see whether the numerator has shrunk.