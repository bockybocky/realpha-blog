...
![Three horizontal bars from top to bottom: the first is long, with a sliver of own capital at the front and a long borrowed stretch behind; the second is tiny, a twentieth of the first, standing for the price move; the third is as long as the first, standing for the whole position forcibly sold. A small fall, a huge sale.](/figures/leverage-forced-selling-scale-en.svg)
...
![A falling line reaches a node and splits left and right into two paths, each leading to a card: the same decline running into two completely different responses.](/figures/same-drop-two-causes-two-sops-en.svg)
