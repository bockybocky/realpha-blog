...
![Two bars of very different height and a horizontal dashed line; the short bar is Africa in 1945, the tall bar is Africa today, and the tall one just reaches the dashed line marked East Asia's industrialization starting line.](/figures/africa-density-reaches-the-starting-line-en.svg)
...
![Two pairs of bars; in the left pair the capacity bar towers over the demand bar with a long top section marked unsold, in the right pair capacity and demand are nearly level.](/figures/capacity-story-versus-demand-story-en.svg)
...
![Two lines on the same time axis; one saws violently up and down but starts and ends at about the same height, the other rises gently all the way.](/figures/fast-variable-noise-slow-variable-direction-en.svg)
...
![Two lines on a cumulative spending chart; one jumps a large step at the very start, runs flat, then jumps again midway, while the other rises gently from zero and catches up only much later.](/figures/sunk-cost-step-versus-pay-as-you-go-en.svg)
