...
![An early-morning corridor in a hot-spring inn: a guest has just slid open the door of his room, the cold glow of his phone on his face, while far down the hallway a staff member stands bowing against the morning light](/covers/gooaye-2026-08-26-ep691-cover-v2.png)
...
In the second half of Gooaye EP691 (26 August 2026), the host takes stock of two-plus years of using AI, and all three of his expectations reversed: he was not replaced, AI did not let him beat his rivals, and the work did not get easier, with longer hours than before. He still watches which groups move intraday with his own eyes, and estimates three to five out of ten of his trades are now improvised during the session. He admits some of this confidence may be placebo, and that the market seems to have become more efficient, so even with an informational edge you can take damage on the pullback.
...
![Three pairs of opposing arrows side by side: in each, the thin dashed arrow pointing up is what was expected and the thick solid arrow pointing down is what happened, and all three reverse](/figures/three-expectations-reversed-en.svg)
...
![Two rectangles share the same baseline: the tall narrow one on the left is long per task but few tasks; the short wide one on the right is faster per task but far more of them, and its area is larger](/figures/saved-time-reinvested-en.svg)
...
![A vertical dividing line splits the frame in two: on the left two figures and a few blocks of prepared material, on the right a single figure facing it alone](/figures/butler-stops-at-the-door-en.svg)
...
![Two crossing curves: one rises for the number of users, one falls for the advantage it brings, and after the crossing the advantage approaches zero](/figures/edge-becomes-entry-fee-en.svg)
...
![Three tall wide bars on the left against twelve short thin bars on the right, with two horizontal dashed lines marking the difference in their tops](/figures/depth-diluted-en.svg)
...
![A chart with judgment accuracy on the horizontal axis and position size on the vertical, a dot moving along an arrow from lower left to upper right, with a shaded danger zone in the top right corner](/figures/accuracy-versus-size-en.svg)
...
![A vertical bar split into four segments, the smallest at the top colored on its own, while a bracket spanning the whole bar points all the credit at that top sliver](/figures/attribution-stack-en.svg)
...
![Three stretches from left to right: dense small dots, then sparse medium dots, then a single large block, the grain disappearing the further you get from the scene](/figures/detail-decays-with-distance-en.svg)