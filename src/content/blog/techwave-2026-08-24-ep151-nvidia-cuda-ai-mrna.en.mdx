...
![Two bars of very different lengths: the long one on top for the months a team once needed, the short one below with the original length left as a dashed outline, for a weekend now](/figures/kernel-port-team-to-weekend-en.svg)
...
![Two panels compared: on the left a bar rises into a solid ceiling and stops; on the right the ceiling becomes dashed and the bar's arrow passes through, with arrows of outside capital flowing in from both sides](/figures/balance-sheet-ceiling-to-outside-capital-en.svg)
...
![On the left a small solid circle inside a large dashed circle, standing for narrowing a broad definition; an arrow points right to a pair of bars of very different heights, standing for something you can now measure](/figures/moat-definition-narrowed-to-testable-en.svg)
...
![Four walls side by side; the leftmost has visibly dropped and keeps a dashed outline of its original height while the other three still stand tall](/figures/one-wall-lowered-others-still-standing-en.svg)
...
![Two rows of dashed boxes of equal length: in the top row the solid bar is compressed to a short stub, in the bottom row it still fills the box, showing one shrinks with more compute and one does not move at all](/figures/bottleneck-compute-swappable-or-not-en.svg)
...
![Three very tall bars on the left and a dozen or so very short bars covering the baseline on the right, of roughly equal area, joined by an arrow in the middle](/figures/risk-changes-shape-not-total-en.svg)
...
The line I most want to keep is that the first sound of a moat collapsing is usually heard by the people inside it — the kernel engineers announced their own jobs were on the way out while the financials showed nothing at all. It's the reason I stopped looking for lowered walls in the reports and started listening to what the people inside the walls were saying.

Here's a small thing I tried. Today, find the person closest to the front line in your field — not necessarily the boss, often the colleague who has been doing it longest — and ask one question: "What has gotten much easier for you lately?" Write the answer down in one line, with the date beside it. Whatever got easier is likely a wall that's evaporating, and it may be the very one you're living on. The first time I asked, the answer was something I had assumed only I could do.

Three months on, look back at that line and see whether the thing that got easier has become a thing that no longer needs you.