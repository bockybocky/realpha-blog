---
title: "Where the Emptiness Is: Statementdog EP544 on OCP — Power, Water, Light, and One Sentence Worth Chewing On"
description: "Statementdog EP544 covers the week's OCP summit: AMD putting the CPU-to-GPU ratio at one-to-one, a data-centre power roadmap that finally has years attached to it, passive components that are short only in specific part numbers, cold plates whose real barrier turns out to be brazing, and a TSMC executive saying they are close to meeting customer demand. My notes cover six things worth keeping and three layers of follow-on thinking: why bottlenecks land in the least glamorous places, why valuation prices acceleration rather than level, and what an open standard actually changes. Educational notes, not investment advice."
...
![Magical-realist oil painting: a single continuous scene down the central aisle of a data hall in deep perspective, an opened rack panel in the shadowed foreground revealing the dense copper tubing of a cold plate and a heavy busbar, an engineer in the mid-ground bent over the copper plate in his hands, and a bundle of optical fibre at the far end of the aisle throwing warm light back along the corridor](/covers/caibaogou-2026-08-13-544-ocp-cover.png)

> *Thirty spokes share one hub; in its emptiness lies the use of the cart.*<br/>
> *Knead clay into a vessel; in its emptiness lies the use of the vessel.*<br/>
> *Cut doors and windows for a room; in their emptiness lies the use of the room.*<br/>
...
The *level* of supply and demand is: are we short right now. The *acceleration* is: is the shortage getting worse or better. A multiple never reflects the level — the level is already in the reported numbers and already priced — it reflects the market's expectation of the rate of change. The host's framing is exactly right: the capacity additions have largely been caught and at least partly priced, so what matters now is whether the acceleration of this demand is rising, and if it falls, the expectation embedded in the share price falls with it.

Push that through and you get the result: "we're close to meeting customer demand" is good operationally — capacity finally caught up — and the opposite signal for valuation, because the scarcity rent is about to compress. Demand doesn't have to turn negative. The second derivative changing sign is enough. It's also why tightly supplied industries so often turn while still printing record profits: nobody is betting they'll lose money, they're betting the shortage won't get worse.

But there's a boundary to hold here: **this sentence is a lead, not evidence.** The show flagged it clearly — no transcript, no context, nobody in the room, and the fact that both the English and Chinese second-hand versions read similarly makes the original wording more uncertain, not less. So the right use isn't to file "advanced packaging is loosening" as a conclusion. It's to convert it into something to check: at the next call, in the next roadmap, does advanced-packaging capex guidance and lead time go up or down?
...
OCP has pulled the scale-up protocol and optical circuit switching under open standards, and the motive needs no guessing — an interview already called proprietary interfaces the thing blocking progress. What that means for investment reading, though, isn't most people's first instinct.
...
One last thing the episode itself demonstrates. It was recorded while the primary material was still a month from publication, and everything in circulation was photographed slides and second-hand summaries. That gap is where mistakes get made: you're reading fragments somebody else selected, and their purpose in selecting them isn't necessarily yours. What the show does well is say out loud which lines it isn't sure about. **Before the primary sources land, marking the uncertain things as uncertain is worth more than rushing to a conclusion — because it's the only way that, when the material does come out, you can tell what you actually got wrong.**
...
- The four lines from *Tao Te Ching* ch. 11 are my own footnote to the episode, not part of the show
