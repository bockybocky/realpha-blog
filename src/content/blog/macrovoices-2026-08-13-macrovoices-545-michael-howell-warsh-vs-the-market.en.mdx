...
![Two connected pools with water of the same colour flowing from the financial-assets pool into the real-economy pool: the left level falls, the right rises, and the total is unchanged.](/figures/money-moved-not-gone-en.svg)
...
![Three versions of the same yield curve: today's curve, the steepening the chair wants, and the flattening the market naturally tends toward, all diverging from the same point at the short end.](/figures/curve-tug-of-war-en.svg)
...
![Four steps form a self-reinforcing loop: assets rise, collateral values rise, more can be borrowed, and the money goes back into the market; the central bank supplies only the first push, with a note that the loop works just as well in reverse.](/figures/collateral-loop-en.svg)
...
![A wave of liquidity growth divided into calm, speculation, turbulence and rebound, with the current position marked on the downslope of the speculation phase.](/figures/liquidity-cycle-phases-en.svg)
...
![Two distributions of rising stocks: on the left most dots cluster near the index line, on the right only three high dots pull the index up while the rest sit below the zero axis.](/figures/index-vs-your-feel-en.svg)
...
What stayed with me from the whole episode is still the plain sentence he said three times: money doesn't disappear, it just goes and sits somewhere else. That line is why I stopped asking "have I gotten lazy?" — there's no way out of that question. Ask instead "where did the time that used to be here go," and the answer is usually something you can look up.

Here's a small thing I tried, if you want to try it: tonight, pick one thing that feels like it's gotten worse lately — fewer things to say to someone, stamina slipping, a project stuck in place. On paper, write two numbers: roughly how many hours a week you gave it a year ago, and how many now. The difference is the missing money. Then do just one thing: open last week's calendar or your phone's screen-time report and find which slot those hours live in now. Write that next to the difference. My first time I assumed the answer would be work; it turned out to be ten to midnight on my phone, every night. The money was still there. It was just sitting in a different account.