...
![Two containers of equal height; the left one, buying, is filled with homework, while the right one, selling, is almost empty with only a sliver at the bottom, showing that more than nine in ten have no selling criteria](/figures/buy-side-full-sell-side-empty-en.svg)
...
![Two forty-year rising lines on one timeline, both starting at fifteen thousand dollars and ending above a million, with a safe holding only fifteen dollars drawn at 1985 in between](/figures/same-arithmetic-twice-en.svg)
...
![Two identical return axes stacked; the miners' dots on top spread from zero to big winners in a very wide distribution, while the shovel sellers' dots below cluster together, showing two different shapes of exposure](/figures/miners-versus-shovels-en.svg)
...
![A two-by-two of decision quality against outcome quality, with the upper-left cell, good decision and bad outcome, singled out as the one most often misread as failure](/figures/decision-quality-versus-outcome-en.svg)
