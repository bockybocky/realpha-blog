...
![Two panels. In calm times on the left, four bars point in opposite directions and their up and down heights nearly cancel, summing to near zero. On the right, when a real shock hits, the same four positions are thin gray strips lying on the zero line, labeled switched off.](/figures/machine-rotation-two-states-en.svg)
...
![Two bars of equal length act as denominators. The top one is all earnings, with a lower multiple. The bottom one is mostly eaten by gray capital spending, leaving only a right segment of free cash flow, so the denominator shrinks and the multiple jumps.](/figures/earnings-versus-free-cash-flow-en.svg)
...
![A curve that rises steeply then flattens. The steep left segment is labeled excitement, the bend deceleration, and the nearly flat long tail plumbing, marked with a P/E of 12; a bracket under the steep part reads this is the stretch you have to ride.](/figures/excitement-to-utility-curve-en.svg)
...
![Two yield curves cross in 1958 and never cross back, separated by a long stretch marked fifty years, until they finally meet again at the far right. The crossing point is labeled iron-rule sell signal.](/figures/yield-crossover-fifty-years-en.svg)
...
![Two panels. On the left a board reading conclusion: bearish rests on a pillar labeled concentration. On the right the same board sits at exactly the same height, but the original pillar is crossed out and left as a dashed outline while a new pillar labeled Treasuries has appeared to hold it up.](/figures/same-conclusion-new-pillar-en.svg)
