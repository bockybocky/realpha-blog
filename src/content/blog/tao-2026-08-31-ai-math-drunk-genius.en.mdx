...
A result without a denominator can't be used to make a decision. That sentence removes one option for you: treating "solved one problem" as a success rate.

The exercise: go back to the most recent result you used to make a decision—an investment, a project, an exam—and write one number next to it: how many attempts in total. If you can write it, you're done. If you can't, write a question mark next to it, and you're also done; that question mark is what you take with you today, and it is more honest than any score.

Extra credit: from today, one line per attempt. Count the column a month from now; its length is your denominator.
