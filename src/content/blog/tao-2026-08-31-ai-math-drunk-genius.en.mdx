...
![A fraction: the numerator reads solved 1 problem, clear and plain, while the denominator slot is empty with a question mark; three candidate numbers 1, 10 and 100 sit in a row beside it, each turning the fraction into something completely different.](/figures/numerator-without-denominator-en.svg)
...
![A thousand dots laid out as a field with fifty lit up, scattered with no pattern; a small dashed box in the lower right corner labeled the ones you most want solved holds only one or two lit dots.](/figures/fifty-random-solved-en.svg)
...
![A five-link chain: the first four links are drawn short and marked fast while the last, verification, stretches long, and the total length of the chain is set almost entirely by that final stretch](/figures/fast-steps-slow-chain-en.svg)
...
![A funnel narrowing through five layers: 51,110 papers, 4,717, 1,050, 598 and 77; the small box at the bottom is a manual spot-check of 15, with a note that one of them was already solved.](/figures/conjecture-funnel-en.svg)
