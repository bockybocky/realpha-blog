...
ogImage: "/covers/contract-liability-future-revenue-cover.png"
cover: "/covers/contract-liability-future-revenue-cover.png"
---

![Oil-painting magical-realism cover: at dawn a lone figure stands atop a soaring tower above a sea of clouds, gazing at the rising sun, untroubled by the clouds below](/covers/contract-liability-future-revenue-cover.png)

> *I don't fear the drifting clouds that block my sight —*<br/>
> *it's simply that I stand on the highest tier.*<br/>
...
A contract liability is cash a customer has already paid for goods or services the company has not yet delivered, recorded under current liabilities on the balance sheet (Realpha Blog methodology note, 6 July 2026). When the balance keeps growing and later converts into revenue, demand is solid, and for SaaS companies that must recognize revenue month by month it shows order momentum earlier than monthly revenue does. The limit: it is not profit already earned, and it can shrink from a wave of refunds. In US filings look for Deferred revenue, Contract liabilities or Unearned revenue and add the current and non-current portions; under IFRS 15 the balance sheet carries an explicit contract liabilities line.
...
![On the left a cash block for a customer paying $12 up front, with an arrow to twelve monthly cells on the right; the first four are filled as delivered revenue on the income statement, and the remaining eight are empty, still owed to the customer as a contract liability on the balance sheet.](/figures/contract-liability-twelve-months-en.svg)
...
![A timeline with a vertical line marked today: the revenue bar extends only to the left, the contract-liability bar extends a little to the right, and the RPO bar extends further still, so the three differ in how far ahead they let you see.](/figures/contract-liability-visibility-horizon-en.svg)
