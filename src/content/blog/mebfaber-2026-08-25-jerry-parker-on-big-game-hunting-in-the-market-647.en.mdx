...
![Two bars comparing the makeup of the CTA industry; the top bar is entirely trend following, while on the bottom trend following is left with just over half and the rest goes to mean reversion, carry, pattern recognition, short-term trading, and machine learning](/figures/managed-futures-is-a-bag-en.svg)
...
![A bar chart of a year of trades, with eighteen small losing bars below the baseline and a few unusually tall winning bars above carrying the whole year](/figures/few-trades-carry-the-year-en.svg)
...
![The same falling price line: trend following stops at the point where the stop is hit, while the index becomes a row of ever-smaller blocks that runs all the way to the end](/figures/index-shrinks-trend-exits-en.svg)
...
![Two grids of a hundred dots; only four are colored on the left and only four are uncolored on the right, exactly reversed proportions](/figures/four-percent-versus-ninety-six-en.svg)
...
![Two nearly overlapping lines run across most of the chart, then one pulls straight up while the other stays put](/figures/correlated-until-the-outlier-en.svg)

![A whole row of return bars pushed down below their original heights marked by a dashed line, with only the crash bar raised, next to a very small allocation block on the right](/figures/crisis-alpha-trade-off-en.svg)
...
![A jagged price line moving inside a band that stands for normal volatility; the psychological stop drawn inside the band is hit again and again, while the market stop drawn outside it is never touched](/figures/stop-outside-the-noise-en.svg)
...
![A price line hits the stop and exits, a gray band marks the stretch spent flat, then the position is re-entered on a break above the prior high and continues upward](/figures/exit-then-buy-back-on-new-high-en.svg)
...
![A bar spanning the full width of the chart stands for a sixty-year sample, with a tiny bar below, barely visible, standing for three years](/figures/sixty-years-versus-your-patience-en.svg)
...
![Two panels side by side; on the left the loss arrow is short and the gain arrow runs off the frame, on the right the loss arrow is long and the gain arrow is short and cut off](/figures/asymmetry-installed-backwards-en.svg)
...
![On the left a distribution with a fat right tail; on the right the same curve with the right tail cut off into a smooth bell, the removed part marked by a dashed outline](/figures/where-the-cost-was-moved-en.svg)
...
What stuck with me most was Parker calling "never let a profit turn into a loss" one of the worst ideas in history — the computer told him that's exactly where you're supposed to sit. It's the reason I realised I had thought a great deal about the quitting side and almost nothing about the enduring side. I have a dozen versions of when to stop, and not one version of how ugly things are allowed to get while I stay in.

Here's a small thing I tried. Pick something you're in the middle of with no defined end — training, a language, a project that's dragged on, a relationship. Today, write one date on your calendar. It means: until this day, however bad it looks, I don't re-evaluate. Once the date is written, you're done. My first one was three weeks out, and by day nine I wanted to move it; what got me through was photographing that calendar page and setting it as my phone wallpaper.

When the day comes, look back and answer one question only: did I sneak in an evaluation before then, and how many times.