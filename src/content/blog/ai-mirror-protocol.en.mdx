...
![Realist-magical oil painting cover: in a dusk-lit study, a dark-haired figure sits at a wooden desk facing a tall bronze-framed mirror; the reflection looking back has white hair, with firefly-like motes of light drifting between them](/covers/ai-mirror-protocol-cover.png)

> *Once I carried ambitions high as the clouds; the drifting years have turned my hair to white. Who knew that in the mirror's glass, my form and shadow would sit pitying one another.*<br/>
...
![A horizontal funnel narrowing from left to right: six thousand commands and eight hundred files enter at the wide end, pass through six stages, and come out of a small opening on the right marked as one sentence.](/figures/six-phase-funnel-en.svg)
...
![One hundred and thirty-four small squares stand for one hundred and thirty-four days: one hundred and three are filled dark for work done between midnight and five in the morning, twenty-eight are light, and only three are empty.](/figures/134-days-grid-en.svg)
...
![Two bars side by side: the left one, five hundred and forty-six commands spent building the system, runs to the top; the right one, nine commands reporting real trades, barely leaves the baseline. The gap is marked as sixty times.](/figures/build-vs-use-en.svg)
...
![Two timelines. The upper one, the remembered version, adds a sell point after the stop-loss signal and ends there. The lower one, the recorded version, reaches the same place with no sell point and keeps running, marked as still held.](/figures/memory-vs-record-en.svg)
...
![A large circle holds many audited items such as holdings, signals, data sources and schedules. Outside it stands one lone block marked as the person placing the trades, tied back to the circle by a dashed line but not inside it.](/figures/audit-coverage-gap-en.svg)
