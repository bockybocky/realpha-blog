...
![On the left a dense field of grey squares stands for a flood of alerts, in the middle a funnel stands for automatic detection and investigation, and on the right only three blue squares remain as the incidents a human actually handles.](/figures/alert-fatigue-funnel-en.svg)
...
![Five instructions enter from the left, a narrow gate in the middle is a small model acting as gatekeeper, three pass through to the large model on the right and two are turned away downward.](/figures/slm-guardrail-gate-en.svg)
...
![On the left a bucket of twelve units stands for a year paid up front, with three units already recognised and emptied; on the right only the first three of twelve monthly cells are filled, showing the bucket fills first and revenue arrives later.](/figures/contract-liability-bucket-en.svg)
