...
![On the left a thin beam runs to a single target; on the right a wide fan covers six falling circles, contrasting one at a time with a whole group at once](/figures/laser-vs-microwave-two-rulers-en.svg)
...
![Three blocks side by side shrinking from large to small, from the size of a building to the size of an armored vehicle, standing for sixty years of falling size, weight, and power](/figures/swap-sixty-years-shrinking-en.svg)
...
![Three steps rising from low to high, labeled 50 kilowatts, 150 kilowatts, and one megawatt, each matched to the targets it can bring down](/figures/laser-power-ladder-en.svg)
...
![A very long bar for the four-million-dollar interceptor and beneath it a nearly invisible thin bar for the thirty-thousand-dollar drone, a ratio of 133 to 1](/figures/cost-asymmetry-133-to-1-en.svg)
...
![Five arcs from outer to inner surrounding the same protected point, the outer layers the more expensive interceptors and the innermost the cheapest](/figures/layered-defense-arcs-en.svg)
...
![In the top half two solid bars show an existing line going from six hundred and twenty to two thousand; in the bottom half a row of dashed empty boxes stands for demand intentions not yet firm](/figures/production-line-vs-intent-en.svg)
...
![Two lines rise together at first; past a threshold the old one bends down while the new one keeps climbing, with now marked in the first half](/figures/addition-phase-before-replacement-en.svg)
...
![On the left five small tasks all connect to the same large circle; on the right four of them connect instead to a small circle and only one still reaches the large one](/figures/personal-layer-cheap-tier-en.svg)
