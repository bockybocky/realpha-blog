...
![Four horizontal bars grow longer top to bottom, from twenty weeks to thirty-six, showing lead times for the same part doubling within half a year](/figures/lead-time-doubling-en.svg)
...
![Two capacity bars of equal length; the high-end segment expands to the right and the consumer segment is squeezed, showing the low end went tight by giving way rather than by selling better](/figures/capacity-crowding-out-en.svg)
...
![Two panels contrasting the direction of cash: on the left money flows from customers into capacity; on the right money flows out of the company first to build the line before it can bid, the shapes reversed](/figures/rent-vs-prefunding-en.svg)
...
![Before, four buckets each stand on their own base, separate; after, the same four sit side by side on one shared base, showing the bottleneck layer merging into one](/figures/buckets-share-one-floor-en.svg)
...
![Three bars of rising height along a timeline; the later they appear the taller and easier to read they are, and most people take over at the rightmost one](/figures/three-stages-of-diffusion-en.svg)
