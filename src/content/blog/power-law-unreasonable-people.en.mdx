...
![Of twenty bars, nineteen sit on the baseline at almost zero while one shoots to the top at sixty times, an extreme difference in height, with a note that the fund as a whole still tripled.](/figures/power-law-one-winner-pays-for-all-en.svg)
...
![Two panels compared: on the left a small weed is being watered by a downward arrow, and on the right a tall flower is cut through at mid-stem by a dashed line, the difference in height set against two opposite actions.](/figures/water-the-weeds-cut-the-flowers-en.svg)
