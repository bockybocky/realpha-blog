...
![On a price baseline the middle group of bars is pushed high and labelled the centre of the boom, while the bars on both sides stay low and are labelled left out, with arrows curving in from both sides to show money flowing to the middle.](/figures/anti-bubble-crowding-en.svg)
...
![Two rectangles compared by area: the left is narrow and tall at $2 unit price and five units, the right is wide and flat at $1 and twenty units, and the right area is twice the left, so halving the price while volume grows makes the total larger.](/figures/unit-cost-down-total-demand-up-en.svg)
