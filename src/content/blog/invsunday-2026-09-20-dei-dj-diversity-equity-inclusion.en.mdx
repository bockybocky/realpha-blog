...
![A 25-year timeline in which the first twenty years are a thin gray bar labeled external push, and the final years turn into a thick blue bar labeled doing it by choice.](/figures/dei-japan-25-year-timeline-en.svg)
...
![Two meeting tables sit side by side: on the left only one of eight seats is blue, while on the right three of the same eight seats are blue.](/figures/one-versus-three-in-the-room-en.svg)
...
![Three horizontal bars narrow from wide to thin: the widest is solid blue and labeled headcount, while the two above are hollow dashed outlines labeled able to speak up and able to enter decisions.](/figures/attribute-base-opinion-upstairs-en.svg)
...
![The upper path runs straight into an orange wall and stops, while a blue lower path goes around it and connects into the room on the right.](/figures/enter-through-the-side-door-en.svg)
...
![A three-tier pyramid in which only the narrowest top tier is colored blue, while the two wider tiers below remain blank.](/figures/change-only-reached-the-top-layer-en.svg)
...
![A two-axis chart with a cluster of blue dots in the upper left for indicators nobody requires yet carry a lot of information, and a cluster of gray dots in the lower right for indicators that are externally required but carry little information.](/figures/required-versus-chosen-governance-signals-en.svg)
...
![A flat line hugs the baseline with a few small gray dots along it, and at the very end a tall orange bar suddenly appears.](/figures/silence-cost-settles-all-at-once-en.svg)
