...
![On the left the textbook seesaw, with the dollar bar up and the gold bar down; on the right that week, with the dollar, gold, and bitcoin bars all rising together and the offset gone.](/figures/same-week-both-sides-rose-en.svg)
...
![Two stacked bars compared: the real rate and inflation expectation segments keep the same height, and only the term premium at the top grows from short to tall, lifting the whole bar.](/figures/term-premium-three-way-split-en.svg)
...
![A large box for forty trillion of debt holds a small box for the annual net interest, and in its corner an almost invisible dot — that is the buyback.](/figures/buyback-scale-nested-en.svg)
...
![A long bar cut in half: the left half is hyperscalers, the right half fans out along spreading lines to four endpoints — neoclouds, sovereign AI, industrial, and enterprise.](/figures/nvidia-revenue-spreading-out-en.svg)

![Three bars pour down into one pool labeled long-duration demand; the AI issuance bar for this year is clearly taller than last year's and comparable in size to the Treasury long-bond bar.](/figures/ai-bonds-vs-treasury-long-end-en.svg)
...
![A waterfall: the positive news bar first, then a deduction for what was already in the price, then a deduction for what the news itself leaked, landing below the zero line.](/figures/good-news-two-deductions-en.svg)
...
![A bar for the fall cut into a fundamentals segment and an uncertainty segment, each running down to a different response: track the reports for an answer, or adjust position size.](/figures/fundamental-vs-uncertainty-ruler-en.svg)
...
![On the left a bar pressing against a fixed horizontal ceiling; on the right the ceiling is a dashed staircase climbing to the upper right, with space still left between it and the bar.](/figures/fixed-ceiling-vs-rising-ceiling-en.svg)
...
![On the left the reply let me think fires a spreading fan of dashed lines labeled high guessing cost; on the right, after a time and criteria are given, only one converging solid line is left and the guessing cost is zero.](/figures/reaction-function-fan-to-line-en.svg)
