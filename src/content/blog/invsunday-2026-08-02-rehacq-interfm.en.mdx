...
![A very tall bar on the left marked 49.8 million subscribers with only five dots beneath it, and a very short bar on the right marked 2 million subscribers with a dense field of dots beneath, showing the gulf in both starting point and number of rivals.](/figures/license-vs-subscribers-en.svg)
...
![Three horizontal bands of different thickness flow into the revenue block on the right; the top two are thin and the bottom one is thickest and the only one in the accent colour.](/figures/three-revenue-lines-en.svg)
...
![Dashed frames for five topics show demand is about equally high for all of them, while solid bars show supply: the first three are nearly full and the last two only part-filled, with the empty space marked as the gap.](/figures/demand-supply-gap-en.svg)
...
![On the left a funnel narrows several inputs into one direction with five identical dots below it; on the right a fan opens outward from a person to dots pointing different ways, one of them in a contrasting colour.](/figures/funnel-vs-fan-en.svg)
...
![Both panels show a falling curve: on the left a dashed ceiling drawn in advance stops it and the curve flattens; on the right there is no such line and the curve runs straight out through the bottom of the frame.](/figures/flagship-vs-bleeding-en.svg)
