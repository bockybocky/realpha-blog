...
On Bloomberg's Odd Lots of 12 September 2026, Ivanhoe Mines founder Robert Friedland takes on a contradiction: copper touched about $14,875 a ton the week of recording, yet a BNEF note cited on the show says global output this year may post its first decline since 2017. Friedland breaks the cause into layers: Chile's Escondida has fallen from close to 2% grade to 0.8% and he expects 0.4% within two years, sulfuric acid went from $150 a ton to well over $1,000 in eight months, and a grinding-mill ring gear that once took four and a half years now takes eight to ten. The limit: Friedland founded a mining company, and host Tracy Alloway said at the end that she didn't hear a lot of solutions.
