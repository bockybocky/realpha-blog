...
![一個由左向右逐段收窄的橫向漏斗，左端接進六千多條指令與八百多個檔案，經過六個階段後在右端收成一個小口，標示「一句話」。](/figures/six-phase-funnel.svg)
...
![一百三十四個小方格代表一百三十四天，其中一百零三格塗深代表凌晨零到五點動過工，二十八格淺色，只有三格是空的。](/figures/134-days-grid.svg)

**「依你建議」53 次。** 我以為我在指揮系統，紀錄顯示很多時候是系統在指揮我。

**蓋系統 546 次，真實下單回報 9 次。** 我蓋了一間自動化投研公司——然後最誠實的統計是：我花在「蓋」的力氣，是花在「用」的 60 倍。

![兩根長條並列，左邊代表蓋系統的五百四十六次高聳到頂，右邊代表真實下單的九次幾乎貼在底線上，兩者高度差標示為六十倍。](/figures/build-vs-use.svg)
...
![上下兩條時間軸，上面那條記憶版本在停損訊號後多出一個賣出點就結束，下面那條紀錄版本走到同一位置卻沒有賣出點，線繼續延伸標示仍在持股。](/figures/memory-vs-record.svg)
...
![一個大圓圈內裝著持股、訊號、資料源、排程等許多被審計的項目，圓圈外孤零零站著一個標著下單的人的方塊，用虛線連回圓圈但不在圈內。](/figures/audit-coverage-gap.svg)
